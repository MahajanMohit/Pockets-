...
object ImageAnalysisService {
    ...
    /**
     * Copies the source URI into filesDir/captures/<uuid>.png (lossless PNG).
     * PNG is preferred for screenshots as it preserves text edges without artefacts.
     * Returns null if the captures directory has exceeded 50 MB or if IO fails.
     */
